...
/////////////////
const BotName = 'FAJAR BOT'; 
const instagram = 'https://instagram.com/aadit0215'; 
const telegram = 'https://t.me/rkmiyo'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@aadit0215`)
})
